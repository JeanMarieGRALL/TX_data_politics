...
Resultats = Resultats[,c("candidat","code_commune","libelle_commune","rapport_commune_France","p_voix", "p_voix_France")]

saveRDS(Resultats, "../fichiers_RDS/resultats_1er_tour_2022.rds")

communes <- readOGR(dsn = "../../../../DONNEES/communes-20220101-shp", layer = "communes-20220101", GDAL1_integer64_policy = TRUE,encoding = "UTF-8", use_iconv = TRUE,verbose=FALSE)


communes <- spTransform(communes, CRS("+init=epsg:4326"))

saveRDS(communes, "../fichiers_RDS/communes_1er_tour_2022_entier.rds")
...
communes <- communes[str_sub(communes$insee,1,2) == "83",]
